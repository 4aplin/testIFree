...
//        Update();
    ...
    private static void Update()
    {
        ...
        catch (NumberFormatException e){lastPageLoadCounter = lastPageLoadCounter + 1;}
    }
...
//    }
    ...
    public static void WaitPageLoaded(int pageLoads, Integer timeout)
    {
        ...
        Waiter.Wait(() -> CheckPageLoaded(pageLoadCounter), "Waiting for the page to complete the transition", (timeout != null) ? timeout : 30000);
        CheckServerException();
        Assert.assertEquals(pageLoadCounter, lastPageLoadCounter, "An unexpected page jump was made");
    }
